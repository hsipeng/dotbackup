...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (obj instanceof PageHelper&&CommonUtil.startWithIgnoreCace(boundSql.getSql(), "select")&& ((PageHelper<Object>) obj).isIsgetTotal()) {
			 ...
			 */
			/**
			 * if(page.getTotalSize()==0||page.getPageCount()<page.getPageNo()){
			...
			/**
			 * ReflectUtil.setFieldValue(boundSql,"parameterObject",page.
			 * getParamObject());
			 */
		}
		Object result = invocation.proceed();
		/**
		 * if (obj instanceof PageHelper) { @SuppressWarnings("unchecked")
		 * PageHelper<Object> page = (PageHelper<Object>)obj;
